...
export default function FAQPage() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: (
        <p>
          Sí, los sábados de 9 a 10hs principiantes, de 10 a 11 avanzados y de 11 a 11:30 práctica
          danzante. Presencial en Iguazú, retransmitida por TikTok Live.
        </p>
      ),
    },
    {
      ...
      answer: <p>Estamos viendo de armar un nuevo grupo los lunes de 19 a 20hs.</p>,
    },
    {
      category: "clases",
    ...
    },
    {
      ...
      answer: <p>Sí, todos los domingos de 22 a 00:00 hacemos una práctica danzante con reserva previa.</p>,
    },
...

    {
      ...
      answer: (
        <>
          <p>
            De martes a domingos de 17 a 19hs en Cruceros Iguazú, combinación de show de tango
            electrónico + música internacional en vivo.
          </p>
          <p>
      ...
      <section className="faq-filter">
        <div className="container">
          ...
          <div className="filter-buttons">
            <button className={`filter-btn ${filter === "all" ? "active" : ""}`} onClick={() => applyFilter("all")}>
              Todas
            </button>
            <button className={`filter-btn ${filter === "shows" ? "active" : ""}`} onClick={() => applyFilter("shows")}>
              Shows
            </button>
            <button className={`filter-btn ${filter === "clases" ? "active" : ""}`} onClick={() => applyFilter("clases")}>
              Clases
            </button>
            <button className={`filter-btn ${filter === "moda" ? "active" : ""}`} onClick={() => applyFilter("moda")}>
              Moda
            </button>
          </div>
        </div>
        ...
        <div className="container">
          <div className="faq-container">
            {faqItems
              ...
              .map((faq, index) => (
                <div key={index} className="faq-item" data-category={faq.category}>
      ...
      <section className="contact-section">
        <div className="container">
          ...
          <div className="contact-buttons">
            ...
            <a href="mailto:undertangoclub@gmail.com" className="contact-button email-button">
