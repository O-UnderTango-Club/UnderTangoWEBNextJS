...
- Programada es una vista calculada: la acción conserva su estado operativo y ranking, pero `activar_en` todavía está en el futuro. No consume un cupo de Frentes. Al llegar la fecha/hora de Córdoba vuelve a evaluarse automáticamente; si no tiene otros bloqueos, entra como disponible sin mover posiciones.
